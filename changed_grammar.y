...
| p_type "void"
;
fun_declaration: type_specifier p_id_index ID declare_func '(' params ')' compound_stmt
;
params: param_list
| p_type "void"
;
...
;
iteration_stmt: "while" while_start '(' expression ')' while_condition statement
;
return_stmt: "return" ';'
| "return" expression ';'
;
switch_stmt: "switch" switch_start '(' expression ')' fake_save '{' case_stmts default_stmt '}'
;
